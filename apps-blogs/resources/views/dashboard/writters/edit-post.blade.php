            ...
            <form action="{{ route('post_update',$post->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                        value="{{ old('title',$post->title) }}" placeholder="Masukkan Judul Blog">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="category">
                        ...
                        <option value="{{ $item->id }}" {{ $item->id==$post->id_categories?'selected':'' }}>{{ $item->code_categories.'-|-'.$item->categories }}</option>
                        @endforeach
                      </select>                      
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="content" rows="5" id="contents"
                        placeholder="Masukkan Konten Blog">{{ old('content',$post->content) }}</textarea>
